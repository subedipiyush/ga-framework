...
/**
 * Implement this interface to provide a crossover operator/method for the framework
 ...
 */
@FunctionalInterface
public interface CrossOverStrategy<A, C extends Comparable<C>> {
    ArrayList<Genotype<A, C>> crossOver(final ArrayList<Genotype<A, C>> parents);
}